...
from .models import TfidfSVMModel
...
def generate_submission_from_model(
    model_type: Literal["tfidf_svm", "transformer"],
    model,
    ...
    """
    Generate Subtask B submission with columns:
        row_id, label (0..NUM_LABELS-1)
    """
